...
const ip0 = faker.internet.ip();

const opq1 = faker.internet.password();
const opq2 = faker.internet.password();

exports.seq = [
{"emitter":"MyJanusInstance","type":128,"timestamp":1499105773182086,"event":{"transport":"janus.transport.rabbitmq","id":"0x607000004230","data":{"event":"connected"}}},
{"emitter":"MyJanusInstance","type":256,"timestamp":1499105773182186,"event":{"status":"started","info":{"janus":"server_info","name":"Janus WebRTC Gateway","version":40,"version_string":"0.4.0","author":"Meetecho s.r.l.","commit-hash":"3d0d248e9f8be4ed793c881513e7e87cb431d19e","compile-time":"Thu 19 Apr 17:11:56 CEST 2018","log-to-stdout":true,"log-to-file":false,"data_channels":true,"session-timeout":60,"reclaim-session-timeout":0,"server-name":"MyJanusInstance","local-ip":ip0,"ipv6":false,"ice-lite":false,"ice-tcp":false,"full-trickle":false,"rfc-4588":false,"api_secret":false,"auth_token":false,"event_handlers":true,"transports":{"janus.transport.http":{"name":"JANUS REST (HTTP/HTTPS) transport plugin","author":"Meetecho s.r.l.","description":"This transport plugin adds REST (HTTP/HTTPS) support to the Janus API via libmicrohttpd.","version_string":"0.0.2","version":2},"janus.transport.rabbitmq":{"name":"JANUS RabbitMQ transport plugin","author":"Meetecho s.r.l.","description":"This transport plugin adds RabbitMQ support to the Janus API via rabbitmq-c.","version_string":"0.0.1","version":1},"janus.transport.websockets":{"name":"JANUS WebSockets transport plugin","author":"Meetecho s.r.l.","description":"This transport plugin adds WebSockets support to the Janus API via libwebsockets.","version_string":"0.0.1","version":1},"janus.transport.pfunix":{"name":"JANUS Unix Sockets transport plugin","author":"Meetecho s.r.l.","description":"This transport plugin adds Unix Sockets support to the Janus API.","version_string":"0.0.1","version":1}},"events":{"janus.eventhandler.rabbitmqevh":{"name":"JANUS RabbitMQEventHandler plugin","author":"Meetecho s.r.l.","description":"This is a trivial RabbitMQ event handler plugin for Janus.","version_string":"0.0.1","version":1},"janus.eventhandler.sqlite":{"name":"Janus SQLite event recorder","author":"Marshall Quander <marshall@quander.me>","description":"Janus event handler for outputting event logs to SQLite.","version_string":"0.1.0","version":1},"janus.eventhandler.sampleevh":{"name":"JANUS SampleEventHandler plugin","author":"Meetecho s.r.l.","description":"This is a trivial sample event handler plugin for Janus, which forwards events via HTTP POST.","version_string":"0.0.1","version":1}},"plugins":{"janus.plugin.voicemail":{"name":"JANUS VoiceMail plugin","author":"Meetecho s.r.l.","description":"This is a plugin implementing a very simple VoiceMail service for Janus, recording Opus streams.","version_string":"0.0.7","version":7},"janus.plugin.audiobridge":{"name":"JANUS AudioBridge plugin","author":"Meetecho s.r.l.","description":"This is a plugin implementing an audio conference bridge for Janus, mixing Opus streams.","version_string":"0.0.10","version":10},"janus.plugin.echotest":{"name":"JANUS EchoTest plugin","author":"Meetecho s.r.l.","description":"This is a trivial EchoTest plugin for Janus, just used to showcase the plugin interface.","version_string":"0.0.7","version":7},"janus.plugin.recordplay":{"name":"JANUS Record&Play plugin","author":"Meetecho s.r.l.","description":"This is a trivial Record&Play plugin for Janus, to record WebRTC sessions and replay them.","version_string":"0.0.4","version":4},"janus.plugin.textroom":{"name":"JANUS TextRoom plugin","author":"Meetecho s.r.l.","description":"This is a plugin implementing a text-only room for Janus, using DataChannels.","version_string":"0.0.2","version":2},"janus.plugin.videoroom":{"name":"JANUS VideoRoom plugin","author":"Meetecho s.r.l.","description":"This is a plugin implementing a videoconferencing SFU (Selective Forwarding Unit) for Janus, that is an audio/video router.","version_string":"0.0.9","version":9},"janus.plugin.videocall":{"name":"JANUS VideoCall plugin","author":"Meetecho s.r.l.","description":"This is a simple video call plugin for Janus, allowing two WebRTC peers to call each other through the gateway.","version_string":"0.0.6","version":6},"janus.plugin.nosip":{"name":"JANUS NoSIP plugin","author":"Meetecho s.r.l.","description":"This is a simple RTP bridging plugin that leaves signalling details (e.g., SIP) up to the application.","version_string":"0.0.1","version":1},"janus.plugin.streaming":{"name":"JANUS Streaming plugin","author":"Meetecho s.r.l.","description":"This is a streaming plugin for Janus, allowing WebRTC peers to watch/listen to pre-recorded files or media generated by gstreamer.","version_string":"0.0.8","version":8},"janus.plugin.eventsrelay":{"name":"JANUS EventsRelay plugin","author":"Meetecho s.r.l.","description":"This is a trivial events relay plugin for Janus, to push custom content to event handlers.","version_string":"0.0.1","version":1},"janus.plugin.sip":{"name":"JANUS SIP plugin","author":"Meetecho s.r.l.","description":"This is a simple SIP plugin for Janus, allowing WebRTC peers to register at a SIP server and call SIP user agents through the gateway.","version_string":"0.0.7","version":7}}}}},
{
   "type": 128,
